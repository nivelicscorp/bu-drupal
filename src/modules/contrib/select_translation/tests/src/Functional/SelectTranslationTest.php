...
namespace Drupal\Tests\select_translation\Functional;
 ...
 *
 * @group select_translation
 */
class SelectTranslationTest extends BrowserTestBase {
  ...
  public function testUninstallation() {
    // Go to uninstallation page an uninstall select_translation:
    $session = $this->assertSession();
    $page = $this->getSession()->getPage();
    $this->drupalGet('/admin/modules/uninstall');
    $session->statusCodeEquals(200);
    $page->checkField('edit-uninstall-select-translation');
