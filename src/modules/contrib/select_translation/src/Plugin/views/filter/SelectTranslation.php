...
class SelectTranslation extends FilterPluginBase {
  ...
  public function query() {
    ...
    // Use core fallback candidates.
    elseif ($this->value == 'fallback') {
      $context = ['langcode' => $current_language, 'operation' => 'select_translation'];
      $list = \Drupal::service('language_manager')->getFallbackCandidates($context);
    }
