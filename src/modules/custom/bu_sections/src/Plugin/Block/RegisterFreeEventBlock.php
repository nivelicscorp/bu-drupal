 ...
 *
 * @Block(
 *   id = "register_free_event_block",
 *   admin_label = @Translation("Form to free event register"),
 * )
 */
class RegisterFreeEventBlock extends BlockBase implements BlockPluginInterface, ContainerFactoryPluginInterface {
  ...
  public function build() {
      ...
      return [
        '#theme' => 'bu_register_free_event_block',
        '#items' => '',
        '#cache' => [
          'disabled' => TRUE
        ],
